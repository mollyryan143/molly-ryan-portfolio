const variables = [
  ...
  { name: 'ppvt_avg', type: 'Control', desc: 'Average PPVT (Peabody Picture Vocabulary Test) score across all waves, measuring verbal and language ability.' },
        ...
        <div className="data-grid" style={{ marginBottom: '1.5rem' }}>
          ...
          <div className="data-card">
            ...
            <ul>
              ...
              <li><strong>Missingness:</strong> Cognitive scores (PPVT, math) are missing for roughly 20% of children</li>
              <li><strong>Cohort effects:</strong> Children born earlier were interviewed as adults in a different economic context</li>
              <li><strong>No causality:</strong> Observational data, so we cannot rule out omitted variables</li>
            </ul>
          </div>
        </div>
