const findings = [
  ...
  },
  {
    ...
    detail: `For non-SNAP children, having a father present in the household is associated with meaningfully higher grade completion — a large and significant effect.
