    ...
    <section id="question">
      <div className="container">
        ...
        <div className="rq-box">
          <p>
            We know that poverty is associated with worse educational outcomes — but which
            specific factors predict how far a child goes in school, and do those factors
            work the same way for children in SNAP households as they do for children who
            never received food assistance? This study uses split-sample regression on four
        ...
        <div className="card">
          ...
          <p style={{ color: 'var(--muted)', fontSize: '0.9rem', lineHeight: 1.75 }}>
            ...
            factors — a stable family, an educated parent, strong academic skills — protect
