const steps = [
  {
    title: 'Data cleaning and variable construction',
  ...
  {
    title: 'Cognitive and work variable extraction',
  ...
  },
  {
    ...
    desc: 'Ran a single OLS model including snap_ever multiplied by each control variable as interaction terms. This formally tests whether the slope for a given variable (e.g., mother\'s education) is statistically significantly different for SNAP vs. non-SNAP children.'
  },
  {
    title: 'Correlation ranking and full model',
